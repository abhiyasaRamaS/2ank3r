...
mulai (){
    echo "Gunakan Troll Project ARS Lagi?"
    echo "y/n?"
    echo
    read lagi
    if [ $lagi = "y" ]; then
            ...
            echo "Terimakasih ya karna sudah menggunakan Troll project ARS"
    fi
}
#spam
spam(){
    ...
    echo "[1] Spam SMS"
    echo "[2] Spam Telp"
    echo "[3] Close Troll Project ARS"
    echo
    echo "1/2/3?"
    read pilih
    if [ $pilih = "1" ]; then
echo "Troll Spam SMS"
            #function spam                                                                                                                               echo
            echo "Silahkan masukan nomor telepon target"
            echo contoh 0812345678
            read target # masukin no telp
            echo                                                                                                                                         echo "Berapa jumlah sms yang mau dikirim?"
            read paket
            echo
            ...
            if [ $confirm = "y" ]; then
                    ...
                    echo
                    echo "Jangan close aplikasi sebelum spam selesai ya"
                    echo "========================================"
                    target_do=$get_sms'/sms.php?nomor='$target'&paket='$paket
                    CURL_RESPONSE=`curl -s -o /dev/null -w "%{http_code}" $target_do`
                    echo " Gunakan tools ini dengan bijak ea"
                    echo
                    echo " Love u always "
                    echo " -C4PUN6-"
                    echo "======================================="
        ...
        mulai
            ...
            #function spam
            echo
            echo "Silahkan masukan nomor telp targetmu"
            echo contoh 0812345678
            read target # masukin no telp
            echo
            ...
            if [ $confirm = "y" ]; then
                  ...
                  echo -e $cek_target
                  echo " Gunakan tools dengan bijak,ok"
                  echo
                  echo " Love u always "
                  echo " -C4PUN6-"
                  echo "========================================"
        ...
        echo "Terimakasih sudah menggunakan Troll project ARS"
        close
    else
        clear
        echo "Kesalahan"
